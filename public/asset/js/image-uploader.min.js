...
!function (e) {
    e.fn.imageUploader = function (t) {
        let n, i = {
            ...
            label: "Chọn hoặc thả hình ảnh tại đây",
            extensions: [".jpg",".JPG",".PNG", ".jpeg", ".png", ".gif", ".svg"],
        ...
        let o = function () {
            ...
            return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || (alert(`Không thểm thêm file"${t.name}" giới hạn ${a.settings.maxFiles} files`), !1)
        }, u = function (t, n) {
