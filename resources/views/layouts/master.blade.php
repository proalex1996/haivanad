            ...
            <div class="container-fluid">
                <div class="header-wrap">
                    <form class="form-header" action="" method="POST">
                        <input class="au-input au-input--xl" type="text" name="search" placeholder="Tìm kiếm hợp đông &amp; báo cáo..." />
...
{{--        Modal--}}
       <div class="modal fade" id="chatbox" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="main-content">
                    <div class="section__content section__content--p30">
                        @yield('content')
                        <div class="row">
                            <div class="col-md-12 m-r-200">
                                <div class="copyright">
                                    <p>Copyright © 2021 KATEC. All rights reserved. Template by <a href="https://katec.vn">KATEC</a>.</p>
                                </div>
                            </div>
                        </div>
                     </div>
