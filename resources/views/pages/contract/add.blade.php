...
<<<<<<< HEAD
                    ...
                    <div id="dropzone">
                        <div type="form" class="dropzone needsclick" id="demo-upload" action="">
                        ...
                        <div class="container">
                            <table id="example" class="display table-borderless table-responsive" style="width:100%">
                                ...
                                <tr class="idTrPayment">
                                    ...
                                    <td><input type="text" class="form-control" id="slovency" name="slovency" required></td>
                                    <td><input type="text" class="form-control" id="ratio" name="ratio" required></td>
                                    <td><input type="text" class="form-control" id="id_value_contract" name="id_value_contract" required></td>
