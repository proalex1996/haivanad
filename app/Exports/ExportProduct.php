...
class ExportProduct implements FromQuery,WithHeadings
{
    ...
    public function query()
    {
        return ProductModel::query()
            ...
            ->select('banner.id','banner.id_banner','banner.banner_adress','banner.size_banner','banner.height_banner','banner.light_system','status_banner.name_status')->orderBy('id','DESC')->getQuery();
    }
